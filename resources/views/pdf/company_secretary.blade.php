...
<table style="border-collapse:collapse;margin-left:42.404pt" cellspacing="0">
    <tr style="height:12pt">
        ...
        <td style="width:476pt" rowspan="2">
            <p class="s7" style="padding-left: 9pt;text-indent: 0pt;line-height: 31pt;text-align: left;">NNC1</p>
        </td>
    </tr>
    ...
    <tr style="height:25pt">
        <td style="width:506pt" colspan="2">
            <p class="s13" style="padding-top: 7pt;padding-left: 2pt;text-indent: 0pt;text-align: left;"><span
                    class="s12">首任公司秘書 </span>First Company Secretary <span class="s51"></span>
                    {{-- <span  class="s8">續上頁 </span><span class="s9">cont’d)</span></p> --}}
        </td>
    </tr>
    <tr style="height:18pt">
        <td >
            {{-- <p class="s13" style="padding-top: 3pt;text-indent: 0pt;text-align: left;"></p> --}}
        </td>
        <td style="width:476pt">
            <p class="s1"
                style="padding-top: 3pt;text-indent: 0pt;line-height: 13pt;text-align: left;">
                公司秘書<span class="s6">( </span>法人團體<span class="s6">) Company Secretary (Body Corporate)</span></p>
        </td>
    </tr>
    <tr style="height:10pt">
        ...
        <td style="width:476pt">
            {{-- <p class="s39" style="text-indent: 0pt;line-height: 9pt;text-align: left;">(<span
                    class="s40">如超過一名公司秘書屬法人團體，請用續頁 </span>C <span class="s40">填報 </span>Use Continuation Sheet C if
                more than 1 company secretary is a body corporate)</p> --}}
        </td>
    </tr>
</table>
<table style="border-collapse:collapse;margin-left:60.884pt" cellspacing="0">
    <tr style="height:33pt">
        ...
        <td
            style="width:121pt;padding-left:30px; border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt">
...
<li data-list-text="3">
    ...
    <h4 style="padding-left: 50px;text-indent: 0px;line-height: 12pt;text-align: left;">香港地址 Hong Kong Address</h4>
        <p class="s18" style="padding-left: 67px;text-indent: 0px;text-align: left;">(<span
            class="s15">本處不接納「轉交」地址及郵政信箱號碼 </span>‘Care of ’ addresses and post office box numbers are not acceptable)
      </p>
    ...
    <p class="s21"
        style="padding-top: 10px;padding-left: 50px;text-indent: 0px;line-height: 11pt;text-align: left;">室／樓／座等
    </p>
    ...
    <p class="s21"
        style="padding-top: 18px;padding-left: 50px;text-indent: 0px;line-height: 11pt;text-align: left;">大廈 </p>
    ...
    <p class="s22" style="padding-left: 50px;text-indent: 0px;line-height: 11pt;text-align: left;">Street<span
            ...
            class="s27">.</span></p>
    <p class="s21"
        style="padding-top: 15pt;padding-left: 50px;text-indent: 0px;line-height: 11px;text-align: left;">區</p>
    <p class="s22" style="padding-left: 50px;  text-indent: 0px;line-height: 9pt;text-align: left;">District</p>
    <p class="s21" style="padding-top: 6px;padding-left: 50px;text-indent: 0px;text-align: left; padding-top:20px">地區 </p>
    <p class="s22" style="padding-top: 2px;padding-left: 50px; padding-top: 1pt; text-indent: 0px;text-align: left;">Region</p>
    <p class="s21" style="padding-top: 1px;padding-left: 50px;text-indent: 0px;text-align: left; padding-top:20px">地區 </p>
    <p class="s22" style="padding-top: 2px;padding-left: 50px;text-indent: 0px;text-align: left;">Email Address</p>
...
<span style="text-indent: 0pt; float:right">
    <input style="width: 200px; height:30px;padding-left:30px; " value="{{$company->Secretary->company_reg_no}}" readonly> 
    <br /></span>
</p>
