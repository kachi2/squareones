    ...
    <div >
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-bottom:10px" cellspacing="0">
            <tr style="height:33pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">
                        {{ shareholder?.chn_last_name }}{{ shareholder?.chn_first_name }}<br /></p>
                </td>
            </tr>
        </table>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt" cellspacing="0">
            <tr style="height:33pt; padding-top:5px">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput"> {{ shareholder?.last_name }}
                      <br /></p>
                </td>
            </tr>
            ...
            <tr style="height:34pt">
                ...
                <td style="width:80%; border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">  {{ shareholder?.first_name }}<br /></p>
                </td>
            </tr>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="">
            <tr style="height:22pt; ">
                ...
                <td style="border:1px solid #000; width:80%">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput"> {{ shareholder?.res_address.flat }} <br /></p>
                </td>
                <td></td>
            </tr>
        </table>
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:34pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">{{ shareholder?.res_address?.building }}<br /> </p>
                </td>
                <td>
                </td>
            </tr>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:34pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">{{ shareholder?.res_address?.street }}<br /></p>
                </td>
                <td></td>
            </tr>
        </table>
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:34pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">{{ shareholder?.res_address?.state }}<br /></p>
                </td>
                <td></td>
            </tr>
        </table>
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:33pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">{{ shareholder?.res_address?.country }}<br /></p>
                </td>
                <td></td>
            </tr>
        </table>
        <table style="border-collapse:collapse;margin-left:53.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:29pt; margin-top:10px">
                ...
                <td style="width:121pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
                    ...
                    <p style="padding:10px">ORDINARY</p>
                </td>
            ...
            <tr style="height:28pt">
                ...
                <td
                    style="width:57pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                    <p style="text-indent: 0pt;text-align: center;" class="dataInput">{{ shareholder?.company_shares[0]?.currency }}<br />
                    </p>
                </td>
                <td
                    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
