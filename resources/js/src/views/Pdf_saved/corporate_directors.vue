    ...
    <div>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt" cellspacing="0">
            <tr style="height:33pt">
                ...
                <td
                    style="width:11pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt">
                    <p style="text-indent: 0pt;text-align: left;"><br /></p>
                </td>
                <td
                    style="width:97pt;border-top-style:solid;border-top-width:1pt;border-bottom-style:solid;border-bottom-width:1pt" >
                    <p style="text-indent: 0pt;text-align: left;" class="dataInput" >{{ corporate?.chn_company_name }}<br /></p>
                </td>
                <td
            ...
            <p class="s29" style="padding-left: 14pt;text-indent: 0pt;line-height: 9pt;text-align: left;">Surname 
                ...
                <td
                    ...
                    <p style="text-indent: 0pt;text-align: left;" class="dataInput">{{ corporate?.company_name }}<br /></p>
                </td>
                <td
                    style="width:57pt;border-top-style:solid;border-top-width:1pt;border-bottom-style:solid;border-bottom-width:1pt">
                    <p style="text-indent: 0pt;text-align: left;"><br /></p>
                ...
                <table style="border-collapse:collapse" cellspacing="0">
                    <tr style="height:25px; ">
                        <td
                            ...
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{ corporate?.flat }}<br /> </p>
                        </td>
                    ...
                    <tr style="height:26pt">
                        <td
                            ...
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{ corporate?.building }}<br /> </p>
                        </td>
                    </tr>
                    ...
                    <tr style="height:26pt">
                        <td
                            style="width:355pt;padding-left: 30px;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{ corporate?.street }}<br /> </p>
                        </td>
                    </tr>
                    ...
                    <tr style="height:26pt">
                        <td
                            style="width:355pt;padding-left: 30px;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{ corporate?.state ?? corporate?.city
                                }}<br />
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr style="height:23pt">
                        <td
                            ...
                            <p 
                                ...
                                <span class="dataInput">{{ corporate?.country }} </span>
                            </p>
                        </td>
            ...
            <tr style="height:46pt; padding-top:30px">
                ...
                <td style="width:432pt" colspan="2">
                    ...
                    <p class="s9" style="padding-left: 28pt;  text-indent: 0pt;text-align: left;">
                        ...
                        The Consent to Act as Director will be delivered for registration not later than 15 days after
