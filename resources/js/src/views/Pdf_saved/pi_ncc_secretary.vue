<template>
    <div>
        ...
        <table style="border-collapse:collapse;margin-left:55.964pt" cellspacing="0">
            ...
            <span v-if="startCompanyStore?.companyInProgress?.names[0]" class="dataInput">Choice Level One:
            ...
            <span v-if="startCompanyStore?.companyInProgress?.names[2]">Choice Level Three: 
                ...
                <span v-if="startCompanyStore?.companyInProgress?.names[4]?.eng_name" class="dataInput"> {{ startCompanyStore?.companyInProgress?.names[4]?.eng_name }} {{ startCompanyStore?.companyInProgress?.names[4]?.eng_prefix }}</span>  &nbsp;
                    <span v-if="startCompanyStore?.companyInProgress?.names[4]?.chn_name" class="dataInput">  {{ startCompanyStore?.companyInProgress?.names[4]?.chn_name }}{{ startCompanyStore?.companyInProgress?.names[4]?.chn_prefix }} </span>
                </span>
                        <br />
                    </p>
                </td>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt" cellspacing="0">
            ...
            <tr style="height:33pt">
                ...
                <td
                    ...
                    <p style="text-indent: 0pt;text-align: left;" class="dataInput"> {{ director?.chn_last_name }}{{ director?.chn_first_name }}<br /></p>
                </td>
                <td
            ...
            <tr style="height:28pt">
                ...
                <td
                    ...
                    <p class="s46"
                        ...
                        <span style="text-align: right; color:rgb(3, 27, 27); " class="dataInput"> 
                ...
                <table style="border-collapse:collapse" cellspacing="0">
                    <tr style="height:25px; ">
                        <td
                            ...
                            <p style="text-indent: 0px;text-align: left;" class="dataInput"> {{ director?.res_address?.flat }} <br /> </p>
                        </td>
                    ...
                    <tr style="height:26pt">
                        <td
                            ...
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{ director?.res_address?.building }} </p>
                        </td>
                    </tr>
                    ...
                    <tr style="height:26pt">
                        <td
                            style="width:355pt;padding-left:20px; border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{ director?.res_address?.street }} </p>
                        </td>
                    </tr>
                    ...
                    <tr style="height:26pt">
                        <td
                            style="width:355pt;padding-left:20px; border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                            <p style="text-indent: 0px;text-align: left;" class="dataInput">{{
