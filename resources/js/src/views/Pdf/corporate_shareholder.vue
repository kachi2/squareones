    ...
    <div>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="">
            <tr style="height:22pt; ">
                ...
                <td style="border:1px solid #000; width:80%">
                    <p style="text-indent: 0pt;text-align: center;"> {{ corporateShare?.flat }} <br /></p>
                </td>
                <td></td>
            </tr>
        </table>
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:34pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;">{{ corporateShare?.building }} <br /></p>
                </td>
                <td>
                </td>
            </tr>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:34pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;">{{ corporateShare?.street }} <br /></p>
                </td>
                <td></td>
            </tr>
        </table>
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:34pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;">{{ corporateShare?.city ?? corporateShare?.state
                        }}<br /></p>
                </td>
                <td></td>
            </tr>
        ...
        <table style="border-collapse:collapse;margin-left:60.884pt; margin-top:10px" cellspacing="0">
            <tr style="height:33pt">
                ...
                <td style="width:80%;border:1px solid #000">
                    <p style="text-indent: 0pt;text-align: center;">{{ corporateShare?.country }}<br /></p>
                </td>
                <td></td>
            </tr>
        </table>
