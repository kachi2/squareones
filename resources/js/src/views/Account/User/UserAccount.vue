                ...
                <div class="tab-content pt-5">
                    <div class="tab-pane active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header fw-bold bg-transparent border-0">Information</div>
                                    <div class="card-body">
                                        <p class="pl-2">Enter your name, username and primary email address. You can
                                            change your primary email address at any time.</p>
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12">
                                                <button :disabled="detailsForm.isSaving" @click="updateDetails"
                                                    ...
                                                    {{ detailsForm.isSaving ? 'Updating..' : 'Update Details' }}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <EasyDataTable v-else class="easy-data-table" show-index :headers="headers"
                    ...
                    <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                        Your privacy and security are top priority. We do all we can to keep your account secure, and we
                        encourage you to do
                        the same by following best practices: Update your password regularly, enable Two-Factor
                        Authentication, and keep
                        your Support PIN private.
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-6 col-lg-6">
                                <div class="card h-100 border-  ">
                                    ...
                                    <div class=" card-body">
                                        ...
                                        <p>
                                            Changed on Jan 1, 2023, 3:39 PM EST
                                        </p>
                                        <button data-bs-toggle="modal" data-bs-target="#passwordModal"
                                            class="btn btn-secondary mt-2">Update
                                            Password</button>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="card  h-100">
                                    <div class="card-body">
                                        <div class="fw-bold mb-2">2-Factor Authentication
                                            <span v-if="!twoFactorObj.isActivated" class="badge bg-warning"> Not
                                                Activated</span>
                                            <span class="badge"
                                                :class="!twoFactorObj.isEnabled ? 'bg-warning' : 'bg-success'" v-else>{{
                                                    !twoFactorObj.isEnabled ? 'Not Enabled' : 'Enabled' }}</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="modal-title" id="modalTitleId">
                            You may update your password any time. We suggest you choose a strong password and update it
                            regularly,
                            e.g. every 6 months. All new passwords must contain at least 8 characters.
                            We also suggest having at least one capital and one lower-case letter (Aa-Zz), one special
                            symbol (#, &,
                            % etc), and one number (0-9) in your password for the best strength.
                        </p>
                        <div class="row g-3 mt-3">
                            <div class="col-12">
                                <div class="form-label">Old Password:</div>
                                <input v-model="passwordForm.oldPassword" type="password" class="form-control">
                                <span class="small text-danger">{{ passwordForm.invalidPassword }}</span>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <span class="small text-danger">{{ passwordForm.passwordsMatching }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer border-0">
                        ...
                        <button :disabled="passwordForm.isSaving" @click="updatePassword" type="button"
                            ...
                            {{ passwordForm.isSaving ? 'Saving...' : 'Update Password' }}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="enableDisableTwoFactor()" class="row g-3">
                            <div class="col-12">
                                <div class="form-label">Open the two factor authentication app on your device to view
                                    your
...
async function updatePassword() {
    ...
    if (passwordForm.oldPassword.length < 8 || passwordForm.newPassword.length < 8 || passwordForm.newPasswordRepeat.length < 8) {
    ...
    try {
        ...
        passwordForm.oldPassword = passwordForm.newPassword = passwordForm.newPasswordRepeat = ''
...
async function enableDisableTwoFactor() {
    try {
        ...
        const endPointCall = twoFactorObj.currentAction == 'enable' ? api.enableTwoFactor(formData) : api.disableTwoFactor(formData)
        const resp = await endPointCall;
        authStore.twofactorEnabled = twoFactorObj.currentAction == 'enable' ? '1' : null
        // console.log(resp);
