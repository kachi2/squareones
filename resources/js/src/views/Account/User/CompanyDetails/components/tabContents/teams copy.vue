            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="row g-3 mb-4">
                                    ...
                                    <ul class="list-group list-group-flush mt-3">
                                        <li class="list-group-item px-0" v-for="x in filteredUsersBySearch">
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-lg-7 text-info-emphasis fw-bold small">{{ x.email }}
                                                </div>
                                                <div class="col-lg-5">
                        ...
                        <div class="col-lg-6" v-if="infomationOfSelectedRole && filteredUsersBySearch.length">
                            <div class="card h-100 exemptio border-0 bg-light-subtle text-capitalize">
                                <div class="card-header">{{ infomationOfSelectedRole.description }}
                                    <div class="float-end" v-if="filteredUsersBySearch.length == 1">
                    ...
                    <EasyDataTable class="easy-data-table"  :headers="headers" :items="items"
                                    ...
                                    <span class=" cursor-pointer bell dropdown-toggle" data-bs-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-start">
                                            <ul class="list-group list-group-flush  ">
                                                <li @click="removeFromTeam(item.user_id)"
...
function removeFromTeam(user_id: any)
{
        const formData = new FormData();
        const team_id = company.value.teams.id
        formData.append('team_id', team_id);
        formData.append('user_id', user_id);
        const resp = api.removeUserfromTeam(formData)
