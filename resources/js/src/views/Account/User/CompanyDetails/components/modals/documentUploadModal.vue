<template>
    <div>
        ...
        <button ref="openModal" class="btn d-none" data-bs-toggle="modal" data-bs-target="#userDocumentUploadModalEdit">
        </button>

        <div class="modal fade" id="userDocumentUploadModalEdit" tabindex="-1" data-bs-backdrop="static"
...
const save = (async () => {
    ...
    try {
        await api.userUploadDocuments(formData)
