  ...
  routes: [
...

    {
      ...
      children: [
        ...
        { path: 'company-edit/:id?', name: 'Admin-Company-Edit', component: () => import('../views/Account/Admin/CompanyDetails/StartCompany_edit/StartCompany_index.vue') },
